...
global Px100;
global joint_positions pick_pose_base drop_pose_base centr_somewhere;
...
function main_task()
    global joint_positions Px100 pick_pose_base drop_pose_base num_waypoints centr_somewhere;
    ...
    while true
        ...
        executeJointSpaceTrajectory( drop_pose_angle,joint_positions, time_to_return, num_waypoints_last);
        break;
    end
 end
